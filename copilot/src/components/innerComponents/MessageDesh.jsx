  ...
  return (
    <>
      <div className="   bg-white   border-purple-200">
        {/* Navbar Section */}
        <div className="flex items-center justify-between border-b border-purple-200 w-full p-2 relative">
          <div className="md:text-md text-xs font-bold  md:ml-4 ml-1">
            <span className='inline ml-2  sm:text-sm text-lg  sm:text-black
             text-[#b9bcea]'>N</span><span className='hidden sm:inline'>icola Tesla</span></div>

          <div className="flex items-center md:gap-2 md:pr-2 gap-1 pr-1 justify-end ">
            ...
            <div className="bg-[#d8d9f4] p-2 rounded-md cursor-pointer hidden sm:block ">
        ...
        <div className="bg-white p-4  shadow-2xl  rounded-lg  ml-3    ">
